		...
		<div className='mb-20 mt-5 flex items-center'>
			<div className='relative mx-auto max-w-lg overflow-hidden rounded-lg bg-white px-12 py-8 text-center shadow-lg'>
                ...
                Mã OTP không hợp lệ
								...
								<div>
									<span className="font-['Inter'] text-base font-normal leading-normal text-[#494949]">
										Thời gian còn lại:{' '}
									</span>
									<span className="font-['Inter'] text-base font-normal leading-normal text-[#009383]">
										5 phút 00 giây
									</span>
								</div>
							</div>
							...
							<div className='relative z-50'>
								<button
									className='w-full rounded bg-teal-600 px-4 py-2 text-white'
